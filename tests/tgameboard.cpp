...
INSTANTIATE_TEST_CASE_P(tGameboardFenNotationParams,  
                        ...
                        testing::Values( make_pair(make_tuple(71776119061217280ULL, 65280ULL, 9295429630892703744ULL, 129ULL, 4755801206503243776ULL, 66ULL, 2594073385365405696ULL, 36ULL, 1152921504606846976ULL, 16ULL, 576460752303423488ULL, 8ULL, ShumiChess::Color::WHITE, 3, 3, 0ULL, 0, 1),
                                         ...
                                         make_pair(make_tuple(1411781519998976ULL, 450359962745241ULL, 8192ULL, 9223372036854775808ULL, 17592186044416ULL, 8796093022208ULL, 0ULL, 536870912ULL, 0ULL, 0ULL, 562949953421312ULL, 1ULL, ShumiChess::Color::BLACK, 0, 0, 0, 1, 41),
                                                   "R7/3P1pkp/3Nnp2/6p1/2B5/7P/1Pr5/7K b - - 1 41"),
                                         make_pair(make_tuple(68963568317366272ULL, 541367552ULL, 9295429630892703744ULL, 129ULL, 4611686018427387904ULL, 64ULL, 2594073385365405696ULL, 4ULL, 4398046511104ULL, 4ULL, 576460752303423488ULL, 8ULL,  ShumiChess::Color::WHITE, 3, 3, 0ULL, 0, 7),
                                                   "rnb1kb1r/pppp1p1p/5qp1/8/2P5/1P3P2/P2PPP1P/RN1QKB1R w KQkq - 0 7"),
                                         make_pair(make_tuple(20134256927834112ULL, 34363958016ULL, 576460752303423488ULL, 129ULL, 4503599627370496ULL, 1056768ULL, 2308094809027379200ULL, 1099511627776ULL, 1152921504606846976ULL, 33554432ULL, 144115188075855872ULL, 8ULL, ShumiChess::Color::BLACK, 0, 3, 0, 4, 14),
