...
TEST_P(IsKingInCheck, IsKingInCheck) {
    ...
    //string debugStr;
    ASSERT_TRUE (black_safe_white_check_engine.is_king_in_check_t<Color::WHITE>());
    ASSERT_FALSE(black_safe_white_check_engine.is_king_in_check_t<Color::BLACK>());
...
TEST(EngineMoveStorage, PushingMoves) {
    ...
    temp_move_0.en_passant_landingSQ = 19;
    ...
    temp_move_1.en_passant_landingSQ = 44;
    ...
    temp_move_2.castle_rights &= 0b0011;
    ...
    temp_move_3.castle_rights = (temp_move_3.castle_rights & 0b1100) | 1;
    ...
    temp_move_4.castle_rights &= 0b1100;
...
TEST(EngineMoveStorage, PushPopMini) {
    ...
    temp_move_1.castle_rights &= 0b1100;
    test_pushMove(test_engine,temp_move_1);
