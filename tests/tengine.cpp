...
TEST(EngineMoveStorage, PushingMoves) {
    ...
    test_engine.pushMove(Move{BLACK, KNIGHT, 1ULL<<57, 1ULL<<42});
    ...
    test_engine.pushMove(Move{WHITE, PAWN, 1ULL<<27, 1ULL<<35});
    ...
    test_engine.pushMove(Move{WHITE, QUEEN, 1ULL<<4, 1ULL<<11});
    ...
    test_engine.pushMove(Move{WHITE, BISHOP, 1ULL<<5, 1ULL<<12});
    ...
    test_engine.pushMove(Move{WHITE, QUEEN, 1ULL<<11, 1ULL<<35});
    ...
    test_engine.pushMove(Move{WHITE, BISHOP, 1ULL<<12, 1ULL<<21});
    ...
    test_engine.pushMove(Move{WHITE, PAWN, 1ULL<<8, 1ULL<<16});
    ...
    test_engine.pushMove(Move{WHITE, QUEEN, 1ULL<<35, 1ULL<<56});
...
TEST(EngineMoveStorage, PushPopMini) {
    ...
    test_engine.pushMove(Move{BLACK, KNIGHT, 1ULL<<42, 1ULL<<57});
...
TEST(EngineMoveStorage, EngineZobristConsistancy) {
    ...
    test_engine.pushMove(Move{WHITE, PAWN, 1ULL<<11, 1ULL<<27});
