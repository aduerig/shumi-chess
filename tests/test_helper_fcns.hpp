...
bool operator==(const ShumiChess::GameBoard& a, const ShumiChess::GameBoard& b) {
    return (a.black_pawns == b.black_pawns &&
            ...
            a.en_passant_landing_square == b.en_passant_landing_square &&
...
void highlight_board_differences(const ShumiChess::GameBoard& a, const ShumiChess::GameBoard& b) {
    ...
    if (a.black_castle_rights != b.black_castle_rights) {
        cout << "Board 1 Black Castle: " << static_cast<int>(a.black_castle_rights) << endl;
        cout << "Board 2 Black Castle: " << static_cast<int>(b.black_castle_rights) << endl;
    }
    if (a.white_castle_rights != b.white_castle_rights) {
    ...
    if (a.en_passant_landing_square != b.en_passant_landing_square) {
        cout << "Board 1 EnPassant: " << a.en_passant_landing_square << endl;
        cout << "Board 2 EnPassant: " << b.en_passant_landing_square << endl;
    }
