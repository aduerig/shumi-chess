...
Weights::Weights()
{
    ...
    aW[ROOK_ON_OPEN_FILE]    = ROOK_ON_OPEN_FILE_WGHT;
    aW[KING_ON_OPEN_FILE]         = KING_ON_OPEN_FILE_WGHT;
    ...
    aW[DEVELOPMENT_OPENINGK]  = DEVELOPMENT_OPENINGK_WGHT;
    aW[DEVELOPMENT_OPENINGB]  = DEVELOPMENT_OPENINGB_WGHT;
    aW[PASSED_PAWN_CONNECTED]= PASSED_PAWN_CONNECTED_WGHT;
    aW[PASSED_PAWN_CONNECTABLE]= PASSED_PAWN_CONNECTABLE_WGHT;
    aW[NO_PAWNS]              = NO_PAWNS_WGHT;
    aW[ISOLANI_OPEN_FILE]    = ISOLANI_OPEN_FILE_WGHT;
    aW[KING_CENTER_LATE]     = KING_CENTER_LATE_WGHT;
    aW[KEEP_ROOKS_WHEN_DOWN_PAWN] = KEEP_ROOKS_WHEN_DOWN_PAWN_WGHT;
    aW[PAWN_HOLE_OPEN_FILE] = PAWN_HOLE_OPEN_FILE_WGHT;
    aW[NO_MOVE_SAME_TWICE]  = NO_MOVE_SAME_TWICE_WGHT;
    aW[OPPOSITE_BISHOPS]    = OPPOSITE_BISHOPS_WGHT;
    aW[BLOCKED_HOME_BISHOP] = BLOCKED_HOME_BISHOP_WGHT;
    ...
    aW[SIDE_TO_MOVE] = SIDE_TO_MOVE_WGHT;
}
