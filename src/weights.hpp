...
public:
    ...
    static constexpr int ISOLANI_ROOK_WGHT  = -18;    // Rook pawns can be isolated too

    // Backward pawns (holes)
    static constexpr int PAWN_HOLE_WGHT = -18;             // A hole is the square direclty ahead of a backward pawn.
    static constexpr int KNIGHT_HOLE_WGHT = -25;

    // Doubled pawns
    static constexpr int DOUBLED_WGHT      = -28;
    static constexpr int DOUBLED_ROOK_WGHT = -33;          // Doubled pawn or rook file
    ...
    static constexpr int PAWN_ON_CTR_DEF_WGHT = 25;        // center e4,d4 (white); e5,d5, (black) "defensive" center squares
    static constexpr int PAWN_ON_CTR_OFF_WGHT = 35;        // center e4,d4 (black); e5,d5, (white) "offensive" center squares
    static constexpr int PAWN_ON_ADV_CTR_WGHT = 20;        // "advanced center" e6,d6 (White); or e3,d3 (Black)
    static constexpr int PAWN_ON_ADV_FLK_WGHT = 10;        // "advanced flank" c4,f4 (black); c5,f5 (White)

    static constexpr int KNIGHT_ON_CTR_WGHT = 16;  // Knight controlling center squares
    static constexpr int BISHOP_ON_CTR_WGHT = 19;  // Bishop controlling center squares

    static constexpr int TWO_BISHOPS_WGHT = 16;    // 2 or more bishops (only one bonus for multiple bishops)
