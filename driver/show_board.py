...
reset_button = Rectangle(
    Point(square_size * 8, square_size * 5),
    Point(1, square_size * 4)
)
reset_button.setFill(color_rgb(59, 48, 32))
reset_button.draw(win)

reset_button_text = Text(
    Point(square_size * 9, square_size * 4.5), 
    "Reset"
)
reset_button_text.setFill(color_rgb(200, 200, 200))
...
def gui_click_choices():
    ...
    if raw_x > square_size * 8 and raw_x < 1 and raw_y < square_size * 5 and raw_y > square_size * 4:
